...
# anchor = #1 #2 #3
anchor_x = [2800,6200,0]
anchor_y = [0,5200,5200]
...
temp = str(ser.readline().decode('utf-8', errors='replace'))
# Set the figure dimensions
fig = plt.figure()
ax = plt.axes(xlim=(-1000,7000),ylim=(-1000,7000))

# Plot an image containing the room layout
#img = mpimg.imread('C:/Users/gkous/Downloads/DWM1001-Real-Time-Localization-System-main/DWM1001-Real-Time-Localization-System-main/img/half10.png')
...
anim = FuncAnimation(fig, update, interval = 0.001, fargs= previous_value, blit = True) # 0.0000001,
